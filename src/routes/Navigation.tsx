            ...
            <div className="main-layout">
                <nav>
                    ...
                    <ul>
                        <li>
                            <NavLink to={'/register'}
                                     className={({isActive}) => isActive ? 'nav-active' : ''}>Register</NavLink>
                        </li>
                        <li>
                            <NavLink to={'/register-formik'}
                                     className={({isActive}) => isActive ? 'nav-active' : ''}>Register Formik</NavLink>
                        </li>
                        <li>
                        ...
                        <li>
                            <NavLink to={'/formik-components'}
                                     className={({isActive}) => isActive ? 'nav-active' : ''}>Formik
                                Components</NavLink>
                        </li>
                        <li>
                        ...
                        <li>
                            <NavLink to={'/dynamic-form'}
                                     className={({isActive}) => isActive ? 'nav-active' : ''}>Dynamic Form
                            </NavLink>
                        </li>
                    </ul>
                </nav>
